TARGET_BOARD_INFO_FILE := device/nexell/drone_s5p6818/board-info.txt


TARGET_BOARD_PLATFORM 		 := slsiap
TARGET_BOOTLOADER_BOARD_NAME := drone_s5p6818
...
# recovery
TARGET_RECOVERY_FSTAB := device/nexell/drone_s5p6818/recovery.fstab
TARGET_RELEASETOOLS_EXTENSIONS := device/nexell/drone_s5p6818
TARGET_RECOVERY_UPDATER_LIBS += librecovery_updater_drone_s5p6818
TARGET_RECOVERY_UI_LIB := librecovery_ui_drone_s5p6818
...
# certificate
#PRODUCT_DEFAULT_DEV_CERTIFICATE := vendor/nexell/security/drone_s5p6818/release

# opengl
BOARD_EGL_CFG := device/nexell/drone_s5p6818/egl.cfg
...
# sepolicy
BOARD_SEPOLICY_DIRS := \
	device/nexell/drone_s5p6818/sepolicy
